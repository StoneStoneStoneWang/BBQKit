...
@objc (BBQCommodityBean)
public class BBQCommodityBean: NSObject, Mappable , IdentifiableType{
    ...
    @objc public var imgs: [BBQKeyValueBean] {
        
        var result: [BBQKeyValueBean] = []
