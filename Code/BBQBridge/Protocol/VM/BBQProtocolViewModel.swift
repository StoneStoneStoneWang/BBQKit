...
public struct BBQProtocolViewModel: WLBaseViewModel {
    ...
    public init(_ input: WLInput) {
        ...
        if let url = URL(string: "\(BBQConfigure.fetchDomain())other/other_privacyProtocols?encoded=\(BBQConfigure.fetchAppKey())") {
