...
@objc (BBQTranslateBean)
public class BBQTranslateBean: NSObject,Mappable {
...
struct BBQTranslateViewModel: WLBaseViewModel  {
        ...
        let translated: Driver<WLBaseResult> = input
            ...
            .flatMapLatest {
                ...
                if !$0.isEmpty {
                    ...
                    return bbqTranslateResp(BBQTranslateApi.translateFromCNTo($0, style: input.style))
                        .map({ return $0["data"] as! [String: Any] })
                        .mapObject(type: BBQTranslateBean.self)
