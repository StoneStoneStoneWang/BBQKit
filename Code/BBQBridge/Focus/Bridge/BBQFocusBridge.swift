...
extension BBQFocusBridge: UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        let delete = UITableViewRowAction(style: .destructive, title: "删除") { [weak self] (a, ip) in
            ...
            self.focusAction(self.dataSource[ip] ,ip)
    ...
    @objc public func removeFocus(_ focusBean: BBQFocusBean ,_ ip: IndexPath ,_ focusAction: @escaping () -> ()) {
        
        BBQHud.show(withStatus: "移除\(focusBean.users.nickname)中...")
        
        BBQFocusViewModel
            .removeFocus(focusBean.users.encoded, encode: focusBean.encoded)
            .drive(onNext: { [weak self] (result) in
                ...
                case .ok:
                    ...
                    BBQHud.showInfo("移除\(focusBean.users.nickname)成功")
                ...
                case .failed:
                    ...
                    BBQHud.showInfo("移除\(focusBean.users.nickname)失败")
                default: break;
