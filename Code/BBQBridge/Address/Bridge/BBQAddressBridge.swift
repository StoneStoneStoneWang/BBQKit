...
public typealias BBQAddressLoadingStatus = (_ status: Int) -> ()

public typealias BBQAddressAction = (_ actionType: BBQAddressActionType,_ ip: IndexPath?,_ address: BBQAddressBean?) -> ()
...
extension BBQAddressBridge {
    ...
    @objc public func createAddress(_ vc: BBQTableLoadingViewController ,status: @escaping BBQAddressLoadingStatus ,addressAction: @escaping BBQAddressAction ) {
    ...
    @objc public func insertAddress(_ address: BBQAddressBean ,addressAction: @escaping BBQAddressAction) {
...
extension BBQAddressBridge: UITableViewDelegate {
    ...
    @objc public func removeAddress(_ address: BBQAddressBean ,ip: IndexPath) {
        
        BBQHud.show(withStatus: "删除地址中...")
