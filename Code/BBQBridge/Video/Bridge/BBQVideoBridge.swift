...
extension BBQVideoBridge {
    ...
    @objc public func focus(_ uid: String ,encode: String ,isFocus: Bool,focusAction: @escaping BBQVideoAction) {
    ...
    @objc public func like(_ encoded: String,isLike: Bool,liceAction: @escaping BBQVideoAction) {
