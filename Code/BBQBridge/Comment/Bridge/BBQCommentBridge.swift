...
extension BBQCommentBridge {
    ...
    @objc public func addComment(_ comment: BBQCommentBean) {
    ...
    @objc public func addComment(_ encoded: String,content: String ,commentAction: @escaping (_ comment: BBQCommentBean?) -> () ) {
        
        BBQHud.show(withStatus: "发表评论中....")
        ...
        BBQCommentViewModel
            ...
            .drive(onNext: { (result) in
                ...
                case .operation(let comment):
                    ...
                    BBQHud.showInfo("发表评论成功!")
                    
                    commentAction(comment as? BBQCommentBean)
                case .failed(let msg):
