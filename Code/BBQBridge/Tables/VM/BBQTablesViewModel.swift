...
struct BBQTablesViewModel: WLBaseViewModel {
    ...
    struct WLOutput {
        ...
        let tableData: BehaviorRelay<[BBQCircleBean]> = BehaviorRelay<[BBQCircleBean]>(value: [])
        ...
        headerRefreshData
            .drive(onNext: { (result) in
                ...
                case let .fetchList(items):
                    ...
                    output.tableData.accept(items as! [BBQCircleBean])
