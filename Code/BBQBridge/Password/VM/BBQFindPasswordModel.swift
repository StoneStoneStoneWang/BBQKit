...
public struct BBQFindPasswordModel: WLBaseViewModel {
            ...
            .flatMapLatest({ (username) in
                ...
                case .ok:
                    ...
                    let result: Observable<WLBaseResult> = Observable<WLBaseResult>.create({ (ob) -> Disposable in
                        ...
                        bbqVoidResp(BBQApi.smsPassword(username))
        ...
        let completed: Driver<WLBaseResult> = input
            ...
            .flatMapLatest {
                ...
                case .ok:
                    ...
                    return bbqVoidResp(BBQApi.resettingPassword($0.0, password: $0.2, code: $0.1))
