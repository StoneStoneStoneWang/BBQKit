...
extension ZBlackBridge: UITableViewDelegate {
                ...
                ZBlackViewModel
                    ...
                    .drive(onNext: { [weak self] (result) in
                        ...
                        case .ok:
                            ...
                            ZNotiConfigration.postNotification(withName: NSNotification.Name(rawValue: ZNotiRemoveBlack), andValue: nil, andFrom: self.vc)
