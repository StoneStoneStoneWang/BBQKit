...
@objc (BBQVCodeImageTextField)
public final class BBQVCodeImageTextField: BBQLeftImageTextField {
    ...
    public override func commitInit() {
        ...
        bbq_rightViewMode(.always)
        
        bbq_rightView(vcodeItem)
...
public final class WLVCodeTitleTextField: BBQLeftTitleTextField {
