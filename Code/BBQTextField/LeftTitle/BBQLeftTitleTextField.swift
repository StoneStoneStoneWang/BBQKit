...
@objc (BBQLeftTitleTextField)
open class BBQLeftTitleTextField: BBQBaseTextField {
...
extension BBQLeftTitleTextField {
    
    @objc open override func makeAttribute(_ closure: @escaping (BBQLeftTitleTextField) -> ()) {
