...
import UIKit
@objc (BBQLeftImageTextField)
open class BBQLeftImageTextField: BBQBaseTextField {
...
extension BBQLeftImageTextField {
    ...
    @objc open override func makeAttribute(_ closure: @escaping (BBQLeftImageTextField) -> ()) {
