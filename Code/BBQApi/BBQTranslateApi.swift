...
@objc (BBQTranslateStyle)
public enum BBQTranslateStyle: Int {
...
public enum BBQTranslateApi {
    ...
    case translateFromCNTo(_ text: String ,style: BBQTranslateStyle)
    
    case translateToCN(_ text: String ,style: BBQTranslateStyle)
}

extension BBQTranslateApi: WLObserverReq {
